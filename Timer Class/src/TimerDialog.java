...
public class TimerDialog extends JDialog {
	...
	private void initComponents() {
		...
		startButton.addActionListener(new ActionListener() {
			...
			{
				try {
				hours = Integer.parseInt(hourField.getText())* 60*60;
				mins = Integer.parseInt(minField.getText()) * 60;
				secs =Integer.parseInt(secField.getText());
				
				if(mins>3540)
				{
					JOptionPane.showMessageDialog(displayPanel,"Must be less than 59!","Warning",
				...
				catch(NumberFormatException e1)
				{
					...
					JOptionPane.showMessageDialog(displayPanel,"Must be A number!","Warning",
							JOptionPane.WARNING_MESSAGE);
				}
